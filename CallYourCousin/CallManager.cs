...
public class CallManager : MonoBehaviour
{
    ...
    void Start()
    {
        TimeScheduler.OnTimeSkipped += Test;
        TimeScheduler.ScheduledAction scheduledAction = TimeScheduler.ScheduleAction(0, 0, DecreaseAnnoyance);
        ModConsole.Print(scheduledAction == null);
    }

    void Test(int time)
    {
        ModConsole.Print("Time Skipped: " + time);
    }
